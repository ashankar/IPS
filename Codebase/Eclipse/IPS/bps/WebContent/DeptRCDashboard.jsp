...
<table width="800" height="350" border="0" cellpadding="1" cellspacing="1" align="center">
    <tr><td><%@ include file = "Links9.jsp" %></td></tr>
    <tr> <td>
        <h2 align = center>
        <%      String Department = (String)session.getAttribute("Department");
                ...
                rs2 = stmt.executeQuery("SELECT emp_name from employee_details where emp_id = '"+Emp_Id+"'");
                while(rs2.next()) {
     ...
     <h3 align = "center">Regional Centers Dashboard</h3>           
