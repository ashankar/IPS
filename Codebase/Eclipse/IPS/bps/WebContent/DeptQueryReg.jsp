...
<script type="text/javascript">
   ...
   var strPass = fld.value;
    ...
    if (fld.value == "") {
        ...
        error = "The "+fld.name+"word contains illegal characters,plzz retype the password.\n";
        fld.style.background =  '#F5D0A9';
    } 
    else {
        fld.style.background = 'White';
...
<body>
           <%
                ...
                String User = (String)session.getAttribute("User");
                 ...
                 {    %>
<form name ="AdminForm" action = "deptt_reg" method = "post"  onsubmit="return validateFormOnSubmit(this)" >
...
<table width="800" border="0" align="center" cellpadding="1" cellspacing="1">
    <tr>
        <td><table width="800" border="0" cellspacing="0" cellpadding="0">
                ...
                <tr>
                    <td bgcolor="#F7EFE7"><div align="right"><img src="Images/links.gif" width="500" height="27" usemap="#Map2" /></div></td>
        </tr>   </table>  </td>        
    </tr>  
</table>
<table width="800" border="0" align="center" cellpadding="1" cellspacing="1" align="center"> 
    <tr>
        <td> <%@ include file="Links6.jsp" %></td>
</tr></table>
...
<table bgcolor="#F7EFE7" align = center><tr> <td width="800" valign="top" align="center">
    ...
    <tr> 
        ...
        <td width="298"><input type="text" name="empid" ></td>
    </tr>
...
<tr> 
    <td><b>Category:</b></td>
    <td><input type="radio" name="category" value="Experts" checked="true"/>Experts</td>
...
<tr> 
    ...
    <td>       
     ...
     <input name="cntno" type="text" size="10" maxlength="10" >(*Isd/Std code-phone no.)</td>
</tr>
<tr> 
...
<table width = "800"><tr>
<td height="19" colspan="3" bgcolor="#330000" width = "800"><div align="center"><font color="white" size="2"><strong>IGNOU 
