<%-- 
    Document   : IOCGCourseIndex1
    Created on : 3 Sep, 2010, 3:06:49 PM
    Author     : anand
--%>
...
<table width="820" border="0" align="center" cellpadding="1" cellspacing="1">
  <tr>
    <td width="820"><table width="820" border="0" cellspacing="0" cellpadding="0">
      ...
      <tr>
        <td align="center" valign="middle" bgcolor="#F7EFE7"><div align="right"><img src="Images/links.gif" width="500" height="27" border="0" usemap="#Map2" /></div></td>
      </tr>
...
<h3 class="menuheader expandable" align="center">Services</h3>
    <ul class="categoryitems">
    <li><a href="#" rev="lr">Project</a></li>
    <li><a href="http://aciil.ignou.ac.in/cpc1/">Placement </a></li>
    <li><a href="http://aciil.ignou.ac.in/mnrs/">Mobile Number Registration </a></li>
...
<h3 class="menuheader expandable" align="center">View Answer</h3>
    <ul class="categoryitems">
      <li><a href="TokenSearch.jsp">View Answer by Token-id</a></li>
    <li><a href="FAQ.jsp">Frequently Asked Queries</a></li>
                ...
                String course =request.getParameter("course");
                 ...
                 %>
                             ...
                             <table><tr><td><p><strong><font color="black"><u><%=dept_des%>,
                                 Query form for the Course <%=course%></u></font></strong></p></td></tr></table>
                           ...
                           <tr>
                              ...
                              <td align = "center">:</td>
                              <td align="left"><input type="text" name="e_no" tabindex="2"></td>
                            </tr>
                            <tr>
                                <td align="left"><strong><font color="#FF0033">*</font>E-mail</strong></td>
                                <td align = "center">:</td>
                                <td align="left"><input name="email_id" type="text" tabindex="3"></td>
                            </tr>
                            <tr>
								...
								<tr><td align="left"><font color="#FF0033">*</font><strong>Course</strong></td>
                                 <td align = "center">:</td>
                                <td><input name="Course" type="text" id="Course"  value="<%=course %>" tabindex="5" readonly></td></tr>                                  </tr>
                                 ...
                                 <tr>
                                    ...
                                    <td align = "center">:</td>
                                    <td align="left"><input name="subject" type="text" tabindex="6"></td>
                                   </tr>
                                ...
                                <tr>
                                    ...
                                    <td align = "center">:</td>
                                                ...
                                                <select name = "department" readonly>
                                                 <option value = "<%=dept_name%>" readonly><%=dept_des%></option>
                                                </select>
                                                </td>
