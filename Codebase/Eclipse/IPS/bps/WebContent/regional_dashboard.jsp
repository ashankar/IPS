...
<table width="800" height="350" border="0" cellpadding="1" cellspacing="1" align="center">
    <tr><td><%@ include file = "Links4.jsp" %></td></tr>
    <tr> <td align = "center">
        <h3 align = center>
  <% 
       ...
       Connection conn=null;
           ...
           try {
               DataSource ds = (DataSource)new InitialContext().lookup("jdbc/ipsDB");
                ...
                ResultSet rs = stmt.executeQuery("SELECT rc_code,rc_name from regional_center where emp_id = '"+Emp_Id+"'");
                while(rs.next()) {
                   rc_code = rs.getString(1);
                   session.setAttribute("RC_code",rc_code);     
                   String rc_name = rs.getString(2);                   
                    out.println("Regional Center"+" "+"-"+" "+rc_code+" "+rc_name+"</h2>");                       
                   }
  ...
  <b> Welcome <%out.println(User22);%></b>
    ...
    <tr><td bgcolor="#F7EFE7">
       <table width = 700 align = center><tr><td align = center>
                 ...
                 size=2><u>IPS (IGNOU Prashanotri Sewa) for Regional Center Directors </u></FONT></B></P>
