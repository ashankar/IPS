<%-- 
    Document   : NewQueryQA
    Created on : Aug 23, 2010, 3:18:38 PM
...
<form name="NewQueryForm" action = "NewQueryQA" onSubmit="return validateFormOnSubmit(this)" method="post">
<center>
                ...
                <tr><td> <%@ include file = "PCLinks.jsp" %>   </td></tr></table>
                ...
                else
               {
                ...
                String sql = "select token_id,name,email_id,region,subject,date,time,MAPEDNAME from user_query,uploads where department='" +Department+ "' && status = 'New' && user_query.token_id=uploads.UPLOADID && user_query.querytype='Academic'";
