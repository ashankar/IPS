<%-- 
    Document   : qadashboard
    Created on : Aug 23, 2010, 2:43:51 PM
...
<table width="800" height="350" border="0" cellpadding="1" cellspacing="1" align="center">
    <tr><td><%@ include file = "PCLinks.jsp" %></td></tr>
    <tr> <td align = "center">
        <h3 align = center>
  <%
  ...
  <b> Welcome <%out.println(User22);%></b>
    ...
    <tr><td bgcolor="#F7EFE7">
       <table width = 700 align = center><tr><td align = center>
                 ...
                 size=2><u>IPS (IGNOU Prashanotri Sewa) for Query Administrator </u></FONT></B></P>
