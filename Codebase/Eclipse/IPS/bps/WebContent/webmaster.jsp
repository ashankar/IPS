<%--
    Document   : webmaster
    Created on : 20 Oct, 2010, 10:49:54 AM
    Author     : anand
--%>
...
<table width="820" border="0" align="center" cellpadding="0" cellspacing="0" bgcolor="#F7EFE7">
  <tr>
    <td width="820"><table width="820" border="0" cellspacing="0" cellpadding="0">
      ...
      <tr>
        <td height="385" align="center" valign="middle" bgcolor="#FFFFFF"><table width="815" height="379" border="0" cellpadding="0" cellspacing="0" bgcolor="#F7EFE7">
              <tr>
                <td width="880" height="377" valign="top"><table width="400" height="375" border="0" align="left" cellpadding="0" cellspacing="0" bgcolor="#F7EFE7" >
                    <tr>
                      <td width="350" height="350" valign="top" bgcolor="#F7EFE7"><div align="center">
                        <table bgcolor="#F7EFE7">
                            <tr>
...
<h3 class="menuheader expandable" align="center">View Answer</h3>
    ...
    <li><a href="LoginPC.jsp">Computer Division</a></li>
                      ...
                      <td width="662" valign="top" bgcolor="#F7EFE7"><div align="center" >
                      <table align = "center" bgcolor="#F7EFE7" border="0" width = "550" bgcolor="#F7EFE7">
                           <tr><td align = "center">

                          </td></tr>
                                 

                             <table bgcolor="#F7EFE7"><tr><td><p><strong><font color="black"><u>Post IGNOU Website related queries </u></font></strong></p></td></tr></table>
  ...
  <a href="javascript:var popup=window.open('EmailIDHelp.html', 'EmailIDHelp',
            ...
            status=no, toolbar=no, scrollbars=yes, resizable=yes');" tabindex="-1">
                            ...
                            <tr>
                                <tr><td align="left"><strong> &nbsp;&nbsp;Mobile&nbsp;Number</strong></td>
                                <td align = "center"></td>
                                <td align="left"><input name="mobile" type="text" value=""tabindex="4"></td></tr>

							</tr>
                                    <input type="hidden" name = "department" value="CD"></input>
