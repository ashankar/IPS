<%-- 
    Document   : NewQueryIans
    Created on : 20 Oct, 2010, 5:15:23 PM
    Author     : anand
--%>
...
<form name="NewQueryForm" action = "NewQueryIans" onSubmit="return validateFormOnSubmit(this)" method="post">
<center>
                ...
                <tr><td> <%@ include file = "iansLinks.jsp" %>   </td></tr></table>
                ...
                else
               {
                ...
                String sql = "select token_id,name,email_id,region,subject,date,time,MAPEDNAME from user_query,uploads where status = 'Forwarded to IANS' && user_query.token_id=uploads.UPLOADID";
