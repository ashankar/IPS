...
<html xmlns="http://www.w3.org/1999/xhtml">
    ...
    <body  onload= "window.status = 'Welcome to IGNOU Prashnottri Sewa';">
        <form name="form14" action="adminansquery" method="post">
            <center>
                                            ...
                                            <tr>
                                                <td width="800" height="221" bgcolor="#F7EFE7"  valign="top">
                                                    <center>
                                                         <table width="800" border="0" bgcolor="#F7EFE7"align = center>
                                                            <tr>
                                                                <td width="800" align="center" valign="top"> <%@ include file = "Links3.jsp" %></td>
                                                            </tr></table>
                                                        <center>
               								...
               								String Department = (String)session.getAttribute("Department");
                								...
                								stmt = conn.createStatement();
                                                                String sql = "select Token_id,Query_Fwd_date,Query_Answer,Query_Reply_Date,Replied_By,Query_Status,dept_name,FAQ,MAPEDNAME from query_info,uploads where Query_Status = 'Replied' && query_info.Token_id=uploads.UPLOADID";
                                                                ...
                                                                while (rs.next()) {
                                                                    ...
                                                                    session.setAttribute("Input", Input);
                                                                            ...
                                                                            <tr><td align = "center"><input type = radio button name = r1 value = "<%=Input%>"></td>
                                                                                <td align = "center"><%=rs.getString("Token_id")%></td>
                                                                                <td align = "center"><%=rs.getString("Query_Fwd_date")%></td>
                                                                                <td align = "center"><%=rs.getString("Query_Answer")%></td>
                                                                                <td align = "center"><%=rs.getString("Query_Reply_Date")%></td>
                                                                                <td align = "center"><%=rs.getString("Replied_By")%></td>
                                                                                <td align = "center"><%=rs.getString("Query_Status")%></td>
