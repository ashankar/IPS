...
<li><a href="Home.jsp">Home</a></li>
  ...
  <li><a href="NewQuery.jsp">New Query</a></li>
  <li><a href="PendingQuery.jsp">Pending Query</a></li>
  <li><a href="AnsweredQuery.jsp">Answered Query</a>
  <li><a href="deptt_reg.jsp">Register</a></li>
