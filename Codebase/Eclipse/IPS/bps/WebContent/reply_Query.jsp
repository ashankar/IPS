...
<body>
<form name="Reply_Query" action="Reply_Query" method="post">
<center>
    ...
    <tr> 
        ...
        <center>
         <table width="800" border="0" bgcolor="#F7EFE7"align = center>
            <tr>
                <td width="800" align="center" valign="top"> <%@ include file = "Links2.jsp" %></td>
        </tr></table>       
        <center>
            <table border=1 width = 800 > <tr><td> 
                ...
                String sql = "SELECT Token_id,Query_Fwd_date,dept_name,Query_Fwd_To,Time,MAPEDNAME FROM query_info,uploads where dept_name = '"+Department+"' && Query_Fwd_To ='"+User22+"' && Query_Status = 'Expert_Forwarded' && query_info.Token_id=uploads.UPLOADID";
