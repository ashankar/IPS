...
<body>
<form name="NewQueryForm" action = "DeptNewQuery" method="post"> 
<center>
...
<tr><td> <%@ include file = "Links6.jsp" %>   </td></tr></table>
       <center> <table width="800" height="360" border="0" bgcolor="#F7EFE7">
        ...
        <center>
            ...
            <tr><td align = "left"><b>Query Date</b></td><td><input type = text name = Date value = "<%=s7%>" readonly size="20" maxlength = 20></td>
