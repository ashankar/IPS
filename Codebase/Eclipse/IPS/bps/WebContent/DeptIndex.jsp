...
<SCRIPT LANGUAGE = "JAVASCRIPT">
    ...
    //    reason+=valDrop(IndexForm.r1);
        reason+= validateNumeric(IndexForm.emp_id);
     ...
     function enableField2()
      {
         ...
         document.IndexForm.region.disabled=true;
            ...
            <body>
            <form name="IndexForm" action="Dept_Index" onSubmit="return validateFormOnSubmit(this)" method = "post" enctype="multipart/form-data">
            <center>
           <% 
            ...
            <td width="355" align="left"><input name="name" type="text" tabindex="1"></td>
            </tr>
            <tr> 
            ...
            <tr> 
              ...
              <td align="left"><select name="deptFrom" tabindex="3">
               ...
               DataSource ds = (DataSource)new InitialContext().lookup("jdbc/ipsDB");
                ...
                rs = stmt.executeQuery("select * from  dept_details where dept_name ='"+Department+"'");
                while (rs.next()) {   %>
            ...
            e.printStackTrace();
			 ...
			 <tr> 
              ...
              <td width="10" align = "center">:</td>
              <td width="355" align="left"><input name="Subject" type="text" tabindex="5"></td>
            </tr>
			<tr> 
