...
<body>
<form name="form14" action="DeptPendingQuery" method="post">
<center>
...
<td bgcolor="#FFFFFF"><table width="800" border="0" cellspacing="1" cellpadding="1">
    ...
    <tr> 
        ...
        <tr>
        <td width="800" align="center" valign="top"> <%@ include file = "Links6.jsp" %></td>
        </tr></table>       
        <center>
            <table border=1 width = 800 > <tr><td> 
                ...
                String sql = "SELECT * FROM dept_query WHERE Dept_From = '"+Department+"' && status !='Replied'&& STATUS!='New'";
                ...
                while (rs.next()) {
                    ...
                    session.setAttribute("Input", Input);
                        ...
                        <%
            String s1 = "", s2 = "", s3 = "", s4 = "";
            ResultSet rs2 = (ResultSet) session.getAttribute("rs7");
            if (rs2 != null) {
                while (rs2.next()) {
                    s1 = rs2.getString(1);
                    s2 = rs2.getString(2);
              ...
              ResultSet rs5 = stmt.executeQuery("select Query_Details from dept_query where Token_id = '"+s1+"'");
               ...
               Query = rs5.getString(1);
                        ...
                        <td><input type = text name = Fwd_Name size="20" maxlength = 20 value ="<%=s2%>" readonly ></td>
                         
                          
                         <tr><td><b>Pending With</b></td><td><input type = text name = Replied_By value = "<%=s3%>" readonly size="20" maxlength = 20></td>   
                    <td><b>Query Status</b></td><td><input type = text name = Query_Status size="20" maxlength = 20 value = "<%=s4%>" readonly></td></tr>                                 
                               </tr>
                              </table><br>
