...
<body>
<form name="form14" action="RCpendingquery" method="post">
<center>
        ...
        <center>
            <table border=1 width = 800 > <tr><td> 
               ...
               DataSource ds = (DataSource)new InitialContext().lookup("jdbc/ipsDB");
                ...
                String sql = "SELECT * FROM user_query WHERE department = '"+Department+"' && STATUS !='Replied'&& STATUS!='New'";
              ...
              ResultSet rs5 = stmt.executeQuery("select * from user_query where token_id = '"+s1+"'");
               ...
               Token_Num = rs5.getString(9);
                 ...
                 <td><input type = text name = Fwd_Name size="20" maxlength = 20 value ="<%=s5%>" readonly ></td>
                    ...
                    <tr><td width="800"><b>Query Details :-</b><br>&nbsp;&nbsp;&nbsp;<textarea name ="Query_Details" rows="2" cols="90" readonly><%=s3%></textarea></td></tr>
                     </td></tr></table>
