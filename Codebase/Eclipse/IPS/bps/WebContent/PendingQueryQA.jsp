<%-- 
    Document   : PendingQueryQA
    Created on : Aug 23, 2010, 3:22:08 PM
...
<body>
<form name="form14" action="PendingQueyIans" method="post">
<center>
...
<td bgcolor="#FFFFFF"><table width="800" border="0" cellspacing="1" cellpadding="1">
    ...
    <tr>
        ...
        <tr>
        <td width="800" align="center" valign="top"> <%@ include file = "PCLinks.jsp" %></td>
        </tr></table>
        <center>
