<%-- 
    Document   : NewQueryCd
    Created on : Dec 4, 2010, 5:06:35 PM
...
<form name="NewQueryForm" action = "NewQueryCd" onSubmit="return validateFormOnSubmit(this)" method="post">
<center>
                ...
                <tr><td> <%@ include file = "cdlink.jsp" %>   </td></tr></table>
