...
<table width="800" height="350" border="0" cellpadding="1" cellspacing="1" align="center">
    <tr><td><%@ include file = "Links8.jsp" %></td></tr>
    <tr> <td>
        <h2 align = center>
              <% 
                String User22 = ""; 
     ...
     <h3 align = "center">Administrator Dashboard</h3>           
  <h3 align = center> Welcome <%=User22 %> To <%=Department %></h3>
    ...
    <tr><TD bgcolor="#F7EFE7">
       <table width = "700" align = "center"><tr><td align = "left" width = "700">
                ...
                <B><FONT face="Verdana, Arial, Helvetica, sans-serif" size=2><u>Department ADMINISTRATOR DASHBOARD  </u></FONT></B></P>
