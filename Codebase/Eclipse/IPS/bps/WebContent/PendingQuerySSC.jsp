<%-- 
    Document   : PendingQuerySSC
    Created on : 1 Sep, 2010, 4:52:20 PM
    Author     : anand
--%>
...
<body>
<form name="form14" action="PendingQuerySSC" method="post">
<center>
...
<td bgcolor="#FFFFFF"><table width="800" border="0" cellspacing="1" cellpadding="1">
    ...
    <tr>
        ...
        <tr>
        <td width="800" align="center" valign="top"> <%@ include file = "SSCLinks.jsp" %></td>
        </tr></table>
        <center>
