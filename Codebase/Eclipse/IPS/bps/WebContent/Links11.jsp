...
<li><a href="circular.jsp">Circular</a></li>
 <li><a href="DeptIndex.jsp">Post Query</a></li>
 <li><a href="DeptPendingQuery.jsp">Pending Query</a></li>
 <li><a href="DeptNewQuery.jsp">PostReply</a>
  <li><a href="DeptQueryReg.jsp">Register</a></li>
<li><a href="DeptReport.jsp">Reports</a></li>
<li><right><a href="ChangePassword.jsp">Edit Password</a></right></li>
<li><right><a href="CirLogin.jsp">Logout</a></right></li>
</ul>
<br style="clear: left" />
</div> 
</body> 
