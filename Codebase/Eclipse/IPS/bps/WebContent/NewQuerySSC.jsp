<%-- 
    Document   : NewQuerySSC
    Created on : 30 Aug, 2010, 3:52:06 PM
    Author     : anand
--%>
...
<form name="NewQueryForm" action = "NewQuerySSC" onSubmit="return validateFormOnSubmit(this)" method="post">
<center>
                ...
                <tr><td> <%@ include file = "SSCLinks.jsp" %>   </td></tr></table>
                ...
                else
               {
                ...
                String sql = "select token_id,name,email_id,region,subject,date,time,MAPEDNAME from user_query,uploads where (status = 'New' || status ='Forwarded to SSC') && user_query.token_id=uploads.UPLOADID && user_query.querytype='Administrative'";
                ...
                <tr><td align = "left"><b>Query Experts</b></td><td><select name = "Expert">
                 ...
                 <%
                     ...
                     { %>
                      ...
                      <% }
                      %>
                      <option value ="PQA">Programme Coordinator</option>
