...
<html>
    <head>
     ...
     function validateFormOnSubmit(form1) {
                var reason = "";
                reason+= valDrop(form1.dept);
                reason+= validatesubjectfield(form1.subject);
               reason+= validateaddfield(form1.circular);
                if (reason != "") {
    ...
    <body  onload= "window.status = 'Welcome to IGNOU Prashnottri Sewa';">
        <form name="form1" method = "post" action="CircularRC" onsubmit="validateFormOnSubmit(this)" enctype="multipart/form-data">
            <center>    
