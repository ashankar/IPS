...
<table width="800" border="0" align="center" cellpadding="1" cellspacing="1">
  <tr>
    <td><table width="800" border="0" cellspacing="0" cellpadding="0">
      ...
      <tr>
      <td height="5" colspan="3" bgcolor="#000000" align = "center" width = "800"></td>
      </tr>
      <tr>
              ...
              <tr> 
                <td width="800" height="221" align="center"  valign="top" bgcolor="#F7EFE7">
                  <table align = "center" width = "700"><tr><td align = "left">
                    ...
                    <h3 align = center><u> Password Acknowledgement</u></h3>
                  <b><p>Dear User, </p>
                  <p>You have successfully changed your password.</p>
                  
                     <p>Through password you will be 
                    able to Login to our IPS services</p>
                  <p>.Please check your email_id 
                    or login to the portal to view and give reply to the query.</p>
                  <p></p>
                  <p>Thank You,</p>
                  <p>Admin(IPS)</p>
                  <p>&nbsp; </p>
