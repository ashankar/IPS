...
<body>
<form name ="AdminForm" action = "DeptRCReg" method = "post"  onsubmit="return validateFormOnSubmit(this)" >
...
<table bgcolor="#F7EFE7" align = center><tr> <td width="800" valign="top" align="center">
    ...
    <h3 align = center>RC Expert Registration Form</h3>
    <table align="center">
    <tr> 
...
<tr> 
    <td><b>Category:</b></td>
    <td><input type="radio" name="category" value="RCExperts" checked="true"/>RC Experts</td>
...
<tr> 
    ...
    <td>       
     ...
     <input name="cntno" type="text" size="10" maxlength="10" ><font color = "red">(*Isd/Std code-phone no.)</font></td>
</tr>
<tr> 
...
<table width = "800">
<tr>
              <td height="5" bgcolor="#330000" align="center"><font color="white" size="2"><strong>IGNOU
