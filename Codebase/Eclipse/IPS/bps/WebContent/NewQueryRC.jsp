...
<form name="NewQueryForm" action = "NewQueryRC" method="post"> 
<center>
...
<tr><td> <%@ include file = "Links4.jsp" %>   </td></tr></table>
       <center> <table width="800" height="360" border="0" bgcolor="#F7EFE7">
        ...
        <center>
            ...
            <table border = 1 width = 800><tr> 
                    ...
                    <td align = "center"><font color = #74101A><b>RegionalCentre</b></font></td>
                ...
                String RC_code = (String)session.getAttribute("RC_code");
               ...
               if(User == null)
                ...
                String sql = "select token_id,name,email_id,date,region,subject,time,MAPEDNAME from user_query,uploads where department = '" +RC_code+ "' && status = 'RC_Forwarded' && user_query.token_id=uploads.UPLOADID";
                String sql3 = "select emp_name from employee_details where department = '"+RC_code+"' and emp_category = 'RCExperts' ";
            ...
            <tr><td align = "left"><b>Regional Center</b></td><td><input type = text name = Rc value = "<%=s5%>" readonly size="20" maxlength = 20></td>
