...
<li><a href="CircularRC.jsp">Circular</a></li>
 <li><a href="DeptIndexRC.jsp">Post Query</a></li>
 <li><a href="DeptRCPending.jsp">Pending Query</a></li>
 <li><a href="DeptRCNewQuery.jsp">PostReply</a>
  <li><a href="DeptRCReg.jsp">Register</a></li>
