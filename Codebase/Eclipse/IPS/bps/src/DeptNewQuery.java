...
public class DeptNewQuery extends HttpServlet
   {
       public void doPost(HttpServletRequest request,HttpServletResponse response)
                    throws IOException,ServletException
             {
              ...
              RequestDispatcher view =  request.getRequestDispatcher("DeptNewQuery.jsp");
              ...
              stmt.executeUpdate("insert into deptqueryinfo(TokenId,QueryFwdDate,DeptName,QueryStatus,QueryFwdTo,Time)values('"+Token+"',str_to_date('"+Date+"','%d/%m/%Y'),'"+Department+"','Expert_Forwarded','"+Expert+"','"+Time+"')");
              stmt.executeUpdate("update dept_query set status = 'Expert_Forwarded' where Token_id = '"+Token+"' "); 
              }
              RequestDispatcher view =  request.getRequestDispatcher("DeptNewQuery.jsp");
              view.forward(request,response);
              }                 
              ...
              { 
              stmt.executeUpdate("insert into deptqueryinfo(TokenId,QueryFwdDate,QueryAnswer,QueryReplyDate,RepliedBy,DeptName,QueryStatus,EmpId,Time)values('"+Token+"',str_to_date('"+Date+"','%d/%m/%Y'),'"+Query+"',str_to_date('"+Date+"','%d/%m/%Y'),'"+User+"','"+Department+"','Replied','"+Emp_Id+"','"+Time+"')");
              stmt.executeUpdate("update dept_query set status = 'Replied' where Token_id = '"+Token+"'");                    
              RequestDispatcher view =  request.getRequestDispatcher("DeptNewQuery.jsp");
              view.forward(request,response);    
              }      
            }
