...
public class adminpendingquery extends HttpServlet
   {
       public void doPost(HttpServletRequest request,HttpServletResponse response)
                    throws IOException,ServletException
             {
              ...
              {               
              RequestDispatcher view =  request.getRequestDispatcher("deptdshboard.jsp");
              ...
              RequestDispatcher view =  request.getRequestDispatcher("AdminPendingQuery.jsp");
              view.forward(request,response);
              }
              }
