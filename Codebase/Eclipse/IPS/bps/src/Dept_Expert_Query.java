...
public class Dept_Expert_Query extends HttpServlet
   {
   ...
   if(name.equals("") || Emp_id.equals("") || deptFrom.equals("") || Subject.equals("") || date.equals("") || query.equals(""))
      {
      RequestDispatcher view =  request.getRequestDispatcher("Dept_Expert_Query.jsp");
      view.forward(request,response); 
            ...
            if(result>0)
              {
                  response.sendRedirect("DeptAckQuery.jsp");
               } 
            }                                      
