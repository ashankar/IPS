...
public class Deptadmin_reg extends HttpServlet 
{
    ...
    throws ServletException, IOException 
   {
        ...
        String s16 = request.getParameter("region"); 
        ...
        int result = 0;
            ...
            if(s16 == null)
             {
               result = stmt.executeUpdate("insert into employee_details values('"+s1+"','"+s2+"','"+s3+"','"+s4+"','"+s5+"','"+s6+"','"+s7+"','"+s8+"','"+s9+"','"+s10+"',str_to_date('"+s11+"','%d/%m/%Y'),'"+s12+"','"+s13+"')");
               stmt.executeUpdate("insert into login values('"+s1+"','"+s4+"','"+s3+"','"+s14+"','"+s15+"')"); 
              }
             else
              {
               result = stmt.executeUpdate("insert into employee_details values('"+s1+"','"+s2+"','"+s3+"','"+s16+"','"+s5+"','"+s6+"','"+s7+"','"+s8+"','"+s9+"','"+s10+"',str_to_date('"+s11+"','%d/%m/%Y'),'"+s12+"','"+s13+"')");
               stmt.executeUpdate("insert into login values('"+s1+"','"+s16+"','"+s3+"','"+s14+"','"+s15+"')"); 
               }
            if(result>0)
            {
