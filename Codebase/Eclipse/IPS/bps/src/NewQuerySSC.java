...
public class NewQuerySSC extends HttpServlet
   {
       public void doPost(HttpServletRequest request,HttpServletResponse response)
                    throws IOException,ServletException
             {
              ...
              RequestDispatcher view =  request.getRequestDispatcher("NewQuerySSC.jsp");
              ...
              {
              stmt.executeUpdate("insert into query_info(Token_id,Query_Fwd_date,Query_Answer,Query_Reply_Date,Replied_By,dept_name,Query_Status,Emp_Id,FAQ,Time)values('"+Token+"',str_to_date('"+Date+"','%d/%m/%Y'),'"+Query+"',str_to_date('"+Date+"','%d/%m/%Y'),'"+User+"','"+Department+"','Replied','"+Emp_Id+"','Unchecked','"+Time+"')");
